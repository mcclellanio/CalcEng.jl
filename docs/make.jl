...
makedocs(;
    ...
    repo = "https://github.com/mcclellaio/CalcEng.jl/blob/{commit}{path}#{line}",
    sitename = "CalcEng.jl",
    format = Documenter.HTML(; canonical = "https://mcclellaio.github.io/CalcEng.jl"),
    pages = list_pages(),
)

deploydocs(; repo = "github.com/mcclellaio/CalcEng.jl")
